...
class AddToCartUseCaseTest {
    ...
    @Test
    fun succesfull_case_add_item_to_cart() =
        runTest {
            // Given
            val productId = "id-test-1"
            val product =
    ...
    fun valid_product_calls_addToCart_with_expect_values() =
        runTest {
            ...
            val cartItemRepository =
                mockk<CartItemRepository>() // los relax = true pueden funcionar pero podriamos saltarnos
            // casuisticas por lo que es mejor mockk con just Run en sitios especificos que nosotros sepamos
