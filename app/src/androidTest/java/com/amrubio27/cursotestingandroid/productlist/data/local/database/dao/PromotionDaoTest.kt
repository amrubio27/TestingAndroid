...
class PromotionDaoTest {
    ...
    @Test
    fun givenPromotionsList_whenInsertPromotions_thenDataIsPersisted() =
        runTest {
            val promotions =
                listOf(
    ...
    @Test
    fun givenExistingPromotion_whenInsertSameId_thenPromotionIsReplaced() =
        runTest {
            val id = "1"
            val initialPromotion =
                promotionEntity {
                    withId(id)
                    withType("PERCENT")
                }
    ...
    @Test
    fun givenExistingData_whenReplaceAll_thenOldDataIsClearedAndNewDataInserted() =
        runTest {
